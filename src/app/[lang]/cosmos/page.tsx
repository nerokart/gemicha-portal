      ...
      <main className="max-w-7xl mx-auto px-6 pb-24">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {SIGNS.map(sign => (
            <Link 
              key={sign.id} 
              href={`/${currentLang}/cosmos/${selectedTopic}/${sign.id}`}
